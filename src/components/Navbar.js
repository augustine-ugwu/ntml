      ...
      >
        <nav className="container mx-auto flex items-center justify-between p-8">
          ...
          <ul className="hidden lg:flex space-x-8 text-xl">
            <li>
              <a href="/" className="font-heading cursor-pointer">
                Home
              </a>
            </li>
            <li>
              <a href="/about" className="font-heading cursor-pointer">
                About Us
              </a>
            </li>

            <li>
              <a href="/products" className="font-heading cursor-pointer">
                Products
              </a>
            </li>
            <li>
              <a href="/contact" className="font-heading cursor-pointer">
                Contact
              </a>
            </li>
            <li>
