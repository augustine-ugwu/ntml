  ...
  return (
    <section className="relative h-screen overflow-hidden">
          ...
          <ul className="hidden lg:flex space-x-8 text-xl p-10">
            <li>
              <a href="/" className="nav font-heading relative cursor-pointer">
                Home
                <span className="absolute left-0 bottom-0 w-full h-0.2 bg-green-600 transition-all transform duration-300"></span>
              </a>
            </li>
            <li>
              <a
      ...
      <div className="relative z-10 flex flex-col justify-end h-full md:p-24 p-6 text-white">
        <p className="font-heading text-lg md:text-3xl mb-4 max-w-3xl text-green-600">
          National Trucks Manufacturers limited
        </p>
        <h1 className="font-heading text-5xl md:text-8xl font-bold tracking-wide">
          Welcome to National Trucks Manufacturers limited
        </h1>
      </div>
    </section>
  );
